...
export class ServiceComponent implements OnInit {
  ...
  constructor(private modalService: BsModalService, private activatedRoute: ActivatedRoute,
              ...
              private notificationsService: NotificationsService, private service: LayoutService) {
  }
  ...
  ngOnInit() {
    this.activatedRoute.params.subscribe((params: Params) => {
      ...
      if(params['formcode'] == 'd007c633-b405-4f7b-b101-63a2e376fa83'){
        this.ID = 2;
      }else if(params['formcode'] == 'b390e68e-0b96-4641-88f0-2fa6e11246b2'){
        this.ID = 3;
      }else if(params['formcode'] == 'a7a1e05e-32c2-4f44-ad58-306572c64593'){
        this.ID = 4;
      }else if(params['formcode'] == 'd007c633-b805-4f7b-b101-63a2e313fa46'){
        this.ID = 5;
      }else if(params['formcode'] == 'd007c633-b805-4f7b-b101-63a2e313fa48'){
        this.ID = 7;
      }else if(params['formcode'] == 'd007c633-b805-4f7b-b101-63a2e313fa47'){
        this.ID = 8;
      }else if(params['formcode'] == 'd007c633-b805-4f7b-b101-63a2e315fa43'){
        this.ID = 9;
      }else if(params['formcode'] == 'e728b6d3-3db1-49af-8038-30458b648bb2'){
        this.ID = 10;
      }else {

        this.service.getFormData(params['formcode']).subscribe(data => {
          this.ID = 1;
        }, error =>
        {
          this.ID = 11;
  ...
  updateFromSaveformResult(message){
  ...
  async saveForm(formData) {
    ...
    this.serviceService.saveForm(this.Licence_Service_ID, this.Service_ID, this.tskID,
       this.SDP_ID, JSON.stringify(formData), this.DocID, this.todoID).subscribe(message => {
